      ...
      <Navbar expand={false} className="navbar-custom">
        <Container fluid>
          ...
          <NavDropdown
            ...
            onMouseLeave={hideDropdown1}
          >
            <NavDropdown.Item href="new-booking">New Booking</NavDropdown.Item>
            <NavDropdown.Item href="duplicate-booking">
              Duplicate Booking
            </NavDropdown.Item>
            <NavDropdown.Divider />
          ...
          >
            <NavDropdown.Item href="new-booking">Hub</NavDropdown.Item>
            <NavDropdown.Divider />
            <NavDropdown.Item href="new-booking">
              Export Overview
            </NavDropdown.Item>
            ...
            <NavDropdown.Item href="my-customs">My Customs</NavDropdown.Item>
            <NavDropdown.Item href="my-finance">MyFinance</NavDropdown.Item>
            <NavDropdown.Item href="captain-peter">
              Captain Peter
            </NavDropdown.Item>
            <NavDropdown.Item href="payer-standing-instructions">
              Payer standing instructions
            </NavDropdown.Item>
            <NavDropdown.Item href="order-secure-paper">
              Order secure paper
            </NavDropdown.Item>
            <NavDropdown.Item href="case-management">
              Case management
            </NavDropdown.Item>
          ...
          >
            ...
            <NavDropdown.Item href="new-booking">简体中文</NavDropdown.Item>
            <NavDropdown.Item href="new-booking">繁體中文</NavDropdown.Item>
            <NavDropdown.Item href="new-lcl-booking">N한국어</NavDropdown.Item>
            <NavDropdown.Item href="new-lcl-booking">日本語</NavDropdown.Item>
          </NavDropdown> */}
