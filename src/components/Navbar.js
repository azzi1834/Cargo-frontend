...
export default function () {
  return (
    <div className="row">
      <Navbar expand={false} class="navbar navbar-expand-lg navbar-light bg-light">
                  ...
                  <Nav className="justify-content-end flex-grow-1 pe-3 navabr">
                    ...
                    >
                      <div className="d-flex flex-column col-md-6">
                        ...
                        <div>
                          <p className="mt-3">
                            Enhance your business' potential with must-read
                            industry insights, upcoming trends and reports.
                          </p>
                        </div>
                        <div>
                          <Link to={"/insights"}>
